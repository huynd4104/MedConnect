...
INSERT INTO doctors (user_id, specialization_id, full_name, phone_number, clinic_address, experience_years, license_number, photo_path, status, created_at) VALUES
                                                                                                                                                                (@doctor1_user_id, @cardiology_id, N'Bác sĩ Nguyễn Văn A', '0911111111', N'11 Đường A, Quận 1, TP.HCM', 10, 'LIC11111', '/uploads/doctor_a.png', 'Approved', GETDATE()),
                                                                                                                                                                (@doctor2_user_id, @dermatology_id, N'Bác sĩ Trần Thị B', '0922222222', N'22 Đường B, Quận HB, Hà Nội', 5, 'LIC22222', '/uploads/doctor_b.png', 'Approved', GETDATE()),
                                                                                                                                                                (@doctor3_user_id, @pediatrics_id, N'Bác sĩ Lê Văn C', '0933333333', N'33 Đường C, Quận 3, TP.HCM', 8, 'LIC33333', '/uploads/doctor_c.jpg', 'Approved', GETDATE()),
                                                                                                                                                                (@doctor4_user_id, @neurology_id, N'Bác sĩ Phạm Thị D', '0944444444', N'44 Đường D, Quận ĐĐ, Hà Nội', 12, 'LIC44444', '/uploads/doctor_d.jpeg', 'Pending', GETDATE()), -- Chờ duyệt
                                                                                                                                                                (@doctor5_user_id, @cardiology_id, N'Bác sĩ Hoàng Văn E', '0955555555', N'55 Đường E, Quận 1, TP.HCM', 15, 'LIC55555', '/uploads/doctor_e.png', 'Approved', GETDATE()),
                                                                                                                                                                (@doctor6_user_id, @ent_id, N'Bác sĩ Vũ Thị F', '0966666666', N'66 Đường F, Quận BT, Hà Nội', 7, 'LIC66666', '/uploads/doctor_f.jpg', 'Rejected', GETDATE()); -- Bị từ chối (ĐÃ SỬA LỖI - Thêm '/uploads/doctor_f.jpg')
GO
